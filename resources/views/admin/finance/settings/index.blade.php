				...
				<div class="card border-0">
					...
					<div class="card-body pb-6">
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								<h6 class="fs-12 font-weight-bold mb-4"><img src="../../../../../public/img/payments/zarinpal.png" alt="ZarinPal" width="50" height="13" class="mx-2" >{{ __('ZarinPal Payment Gateway') }}<span class="text-primary">({{ __('All Plans') }})</span></h6>
								
								<div class="row">
									<div class="col-md-6 col-sm-12 mb-2">
										<div class="form-group">
											<label class="custom-switch">
												<input type="checkbox" name="enable-zarinpal" class="custom-switch-input" @if (config('services.zarinpal.enable')  == 'on') checked @endif>
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">{{ __('Use ZarinPal Prepaid') }}</span>
											</label>
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												<input type="checkbox" name="enable-zarinpal-subscription" class="custom-switch-input" @if (config('services.zarinpal.subscription')  == 'on') checked @endif>
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">{{ __('Use ZarinPal Subscription') }}</span>
											</label>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">								
										<div class="input-box">								
											<h6>{{ __('Merchant Id') }}<span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
											<div class="form-group">							    
												<input type="text" class="form-control @error('zarinpal_merchant_id') is-danger @enderror" id="zarinpal_merchant_id" name="zarinpal_merchant_id" value="{{ config('services.zarinpal.merchantID') }}" autocomplete="off">
											</div> 
											@error('zarinpal_merchant_id')
												<p class="text-danger">{{ $errors->first('zarinpal_merchant_id') }}</p>
											@enderror
										</div> 
									</div>
									...
									<div class="col-md-6 col-sm-12 mb-2">
										<div class="form-group">
											<label class="custom-switch">
												<input type="checkbox" name="enable-sandbox-zarinpal" class="custom-switch-input" @if (config('services.zarinpal.sandbox')  == 'on') checked @endif>
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">{{ __('Active Sandbox') }}</span>
											</label>
										</div>
									</div>
								</div>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								<h6 class="fs-12 font-weight-bold mb-4"><i class="fa-brands fa-cc-paypal fs-16 mr-2"></i>{{ __('PayPal Payment Gateway') }} <span class="text-primary">({{ __('All Plans') }})</span></h6>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><i class="fa-brands fa-cc-stripe fs-16 mr-2"></i>{{ __('Stripe Payment Gateway')}} <span class="text-primary">({{ __('All Plans') }})</span></h6>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ URL::asset('/img/payments/paystack.svg') }}" alt="Paystack" class="gateway-logo">{{ __('Paystack Payment Gateway')}} <span class="text-primary">({{ __('All Plans') }})</span></h6>
									...
									<div class="col-md-6 col-sm-12 mb-2">
										<div class="form-group">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">{{ __('Use Paystack Prepaid')}}</span>
											</label>
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">{{ __('Use Paystack Subscription')}}</span>
											</label>
										</div>
									</div>
								</div>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ URL::asset('/img/payments/razorpay.svg') }}" alt="Razorpay" class="gateway-logo">{{ __('Razorpay Payment Gateway')}} <span class="text-primary">({{ __('All Plans') }})</span></h6>
									...
									<div class="col-md-6 col-sm-12 mb-2">
										<div class="form-group">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">{{ __('Use Razorpay Prepaid')}}</span>
											</label>
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">{{ __('Use Razorpay Subscription')}}</span>
											</label>
										</div>
									</div>
								</div>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ URL::asset('/img/payments/mollie.svg') }}" alt="Mollie" class="gateway-logo gateway-small-logo">{{ __('Mollie Payment Gateway')}} <span class="text-primary">({{ __('All Plans') }})</span></h6>
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">{{ __('Use Mollie Prepaid')}}</span>
											</label>
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">{{ __('Use Mollie Subscription')}}</span>
											</label>
										</div>
									</div>
								</div>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ URL::asset('/img/payments/braintree.svg') }}" alt="Braintree" class="gateway-logo">{{ __('Braintree Payment Gateway')}} <span class="text-primary">({{ __('Prepaid Plans') }})</span></h6>
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">{{ __('Use Braintree Prepaid')}}</span>
											</label>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">								
										<!-- ACCESS KEY -->
										<div class="input-box">								
											<h6>{{ __('Braintree Private Key')}}</h6>
											<div class="form-group">							    
									...
									<div class="col-lg-6 col-md-6 col-sm-12">		
										<div class="input-box">								
											<h6>{{ __('Braintree Merchant ID')}}</h6>
											<div class="form-group">							    
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											<h6>{{ __('Braintree Environment')}}</h6> 
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">{{ __('Use Coinbase Prepaid')}}</span>
											</label>
										</div>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">		
										<div class="input-box">								
											<h6>{{ __('Coinbase Webhook Secret')}}</h6>
											<div class="form-group">							    
