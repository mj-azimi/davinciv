				...
				<div class="card-body p-0">
					<table class="table" id="database-backup">
						<tbody>
							...
							<tr><td class="justify-content-between d-flex align-items-center pl-5 pr-5 pt-4 pb-4"><span class="font-weight-bold">{{ __('OpenAI Model for Text') }}</span><span class="font-weight-bold">{{ $id->model }}</span></td></tr>
							<tr><td class="justify-content-between d-flex align-items-center pl-5 pr-5 pt-4 pb-4"><span class="font-weight-bold">{{ __('Zarinpal Plan ID') }}</span><span>{{ $id->zarinpal_gateway_plan_id }}</span></td></tr>
							...
							<tr><td class="justify-content-between d-flex align-items-center pl-5 pr-5 pt-4 pb-4"><span class="font-weight-bold">{{ __('Supported Templates') }}</span>{{ ucfirst($id->templates) }}</td></tr>
