						...
						<div class="card special-shadow border-0" id="payment-gateways">
							<div class="card-body">
								...
								<div class="row">								
									<div class="col-lg-6 col-md-6 col-sm-12">							
										<div class="input-box">								
											<h6>{{ __('ZarinPal Plan ID') }} <span class="text-danger">({{ __('Required for Zarinpal') }}) <i class="ml-2 text-dark fs-13 fa-solid fa-circle-info" data-tippy-content="{{ __('You have to get Zarinpal Plan ID in your Zarinpal account. Refer to the documentation if you need help with creating one') }}."></i></span></h6>
											<div class="form-group">							    
												<input type="text" class="form-control" id="zarinpal_gateway_plan_id" name="zarinpal_gateway_plan_id" value="{{ old('zarinpal_gateway_plan_id') }}">
											</div> 
											@error('zarinpal_gateway_plan_id')
												<p class="text-danger">{{ $errors->first('zarinpal_gateway_plan_id') }}</p>
											@enderror
										</div> 						
									</div>
								</div>
