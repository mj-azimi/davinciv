                ...
                <div class="container">
                    ...
                    <div class="row text-center mt-8 mb-8">
                        <div class="col-md-12 title">
                            <h6>{{ __('Benefits') }} <span>{{ config('app.name') }}</span> </h6>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1000" data-aos-once="true" data-aos-duration="1000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>{{ __('Lorem ipsum dolor sit amet est consectetur adipisicing elit. Ut aspernatur mollitia aliquid consectetur illo sapiente nemo obcaecati unde.') }}</p>
            ...
            <section id="features-wrapper">
                ...
                <div class="container">
                    ...
                    <div class="row text-center mb-8">
                        <div class="col-md-12 title">
                            <h6>{{ __('Templates') }} <span>{{ config('app.name') }}</span> </h6>
            ...
            <section id="feedbacks-wrapper">
                ...
                <div class="container pt-4 text-center">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="title">
                            <h6><span>{{ __('Reviews') }}</span> {{ __('Customer') }}</h6>
        ...
        <section id="banner-wrapper">
            ...
            <div class="container">
                ...
                <div class="row mb-7 text-center">
                    ...
                    <div class="title">
                        <h6><span>{{ __('Partners') }}</span> {{ __('Our') }}</h6>
            ...
            <section id="prices-wrapper">
                ...
                <div class="container pt-9">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="title">
                            <h6>{{ __('Plans') }} {{ __('Various') }} <span>{{ __('Subscription') }}</span> </h6>
            ...
            <section id="faq-wrapper">
                <div class="container pt-7">
                    ...
                    <div class="row text-center mb-8 mt-7">
                        <div class="col-md-12 title">
                            <h6><span>{{ __('Questions') }}</span> {{ __('Frequently Asked') }}</h6>
