					...
					<div class="row">
						...
						<div class="col-sm-12">								
							<div class="input-box">	
								...
								<div class="form-group">						    
									<input type="text" class="form-control @error('title') is-danger @enderror" id="title" name="title" placeholder="{{ __('e.g. Amazing cuisine culture of Mexico') }}" required>
									@error('title')
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								...
								<div class="form-group">							    
									<textarea type="text" rows=1 class="form-control @error('keywords') is-danger @enderror" id="keywords" name="keywords" placeholder="{{ __('e.g. taco, sangria, paella') }}"></textarea>
									@error('keywords')
