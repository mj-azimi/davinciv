					...
					<div class="row">
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								...
								<div class="form-group">							    
									<textarea type="text" rows=3 class="form-control @error('title') is-danger @enderror" id="title" name="title" placeholder="{{ __('e.g. 5 best places to visit in Spain') }}" required></textarea>
									@error('title')
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								...
								<div class="form-group">							    
									<textarea type="text" rows=3 class="form-control @error("subheadings") is-danger @enderror" id="subheadings" name="subheadings" placeholder="{{ __('e.g. Barcelona, San Sebastian, Madrid') }}" required></textarea>
									@error('subheadings')
