					...
					<div class="row">
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								...
								<div class="form-group">							    
									<input type="text" class="form-control @error('title') is-danger @enderror" id="title" name="title" placeholder="{{ __('e.g. 5 best places to visit in Spain') }}" required>
									@error('title')
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								...
								<div class="form-group">							    
									<textarea type="text" rows=5 class="form-control @error('description') is-danger @enderror" id="description" name="description" placeholder="{{ __('e.g. describe your blog article') }}" required></textarea>
									@error('description')
