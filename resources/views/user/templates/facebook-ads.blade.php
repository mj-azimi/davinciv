					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-12 col-sm-12">								
							<div class="input-box">								
								...
								<div class="form-group">							    
									<input type="text" class="form-control @error('title') is-danger @enderror" id="title" name="title" placeholder="{{ __('e.g. VR, Toy') }}">
									@error('title')
						...
						<div class="col-lg-6 col-md-12 col-sm-12">								
							<div class="input-box">								
								...
								<div class="form-group">							    
									<input type="text" class="form-control @error('audience') is-danger @enderror" id="audience" name="audience" placeholder="{{ __('e.g. Women, Parents') }}" required>
									@error('audience')
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								...
								<div class="form-group">							    
									<textarea type="text" rows=5 class="form-control @error("description") is-danger @enderror" id="description" name="description" placeholder="{{ __('e.g. VR is an innovative device that can allow you to be part of virtual world') }}" required></textarea>
									@error('description')
