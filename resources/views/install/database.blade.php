                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">								
                                            <div class="input-box">								
                                                ...
                                                <div class="form-group">							    
                                                    <input type="text" class="form-control @error('hostname') is-danger @enderror" id="hostname" name="hostname" value="{{ old('hostname') }}" placeholder="{{ __('Enter Database Hostname')}}" autocomplete="off" required>
                                                    @error('hostname')
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">								
                                            <div class="input-box">								
                                                <h6>{{ __('Port') }}</h6>
                                                <div class="form-group">							    
                                                    <input type="text" class="form-control @error('port') is-danger @enderror" id="port" name="port" value="{{ old('port') }}" placeholder="{{ __('Enter Database Port')}}" autocomplete="off" required>
                                                    @error('port')
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">								
                                            <div class="input-box">								
                                                ...
                                                <div class="form-group">							    
                                                    <input type="text" class="form-control @error('database') is-danger @enderror" id="database" name="database" value="{{ old('database') }}" placeholder="{{ __('Enter Database Name')}}" autocomplete="off" required>
                                                    @error('database')
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">								
                                            <div class="input-box">								
                                                <h6>{{ __('DB User') }}</h6>
                                                <div class="form-group">							    
                                                    <input type="text" class="form-control @error('user') is-danger @enderror" id="user" name="user" value="{{ old('user') }}" placeholder="{{ __('Enter Database User')}}" autocomplete="off" required>
                                                    @error('user')
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">								
                                            <div class="input-box">								
                                                ...
                                                <div class="form-group">							    
                                                    <input type="text" class="form-control @error('password') is-danger @enderror" id="password" name="password" value="{{ old('password') }}" placeholder="{{ __('Enter Database User Password')}}" autocomplete="off">
                                                    @error('password')
