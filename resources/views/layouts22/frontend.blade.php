					...
					<div id="footer" class="container text-center">
						...
						<div class="row">    
							...
							<div class="col-md-4 col-sm-12" id="footer-logo">
								...
								<p class="mb-0">{{ __('Lorem ipsum dolor sit amet est consectetur adipisicing elit. Ut aspernatur mollitia aliquid consectetur illo sapiente nemo obcaecati unde.') }}</p>		
