...
trait VoiceToneTrait
{
    ...
    public function translateTone($tone, $language)
    {
        switch ($language) {
            case 'fa-IR':
                switch ($tone) {
                    case 'funny': return 'خنده دار'; break; 
                    case 'casual': return 'غیر جدی'; break; 
                    case 'excited': return 'برانگیخته'; break; 
                    case 'professional': return 'حرفه ای'; break; 
                    case 'witty': return 'شوخ'; break; 
                    case 'sarcastic': return 'طعنه آمیز'; break; 
                    case 'feminine': return 'زنانه'; break; 
                    case 'masculine': return 'مردانه'; break; 
                    case 'bold': return 'جسور'; break; 
                    case 'dramatic': return 'نمایشی'; break; 
                    case 'gumpy': return 'نامفهموم'; break; 
                    case 'secretive': return 'رازدار'; break; 
                }
                break;
            case 'ar-AE':
                switch ($tone) {
