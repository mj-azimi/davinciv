    ...
    public function createPASPrompt($title, $audience, $description, $language)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "حل مسئله را برای توصیف محصول زیر بنویسید:\n\n" . $description . "\n\nنام محصول:\n" . $title . "\n\nمخاطب هدف:\n" . $audience . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนปัญหา-ปั่นป่วน-แก้ปัญหาสำหรับคำอธิบายผลิตภัณฑ์ต่อไปนี้:\n\n" . $description . "\in\ชื่อผลิตภัณฑ์:\และ" . $title . "\nn\กลุ่มเป้าหมาย:\n" . $audience . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть problem-agitate-solution для такого опису продукту:\n\n" . $description . "\in\Назва продукту:\і" . $title . "\nn\Цільова аудиторія:\n" . $audience . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Rašykite problemą-agituokite-sprendimą šiam gaminio aprašymui:\n\n" . $description . "\in\Produkto pavadinimas:\ir" . $title . "\nn\Tikslinė auditorija:\n" . $audience . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете проблем-раздвижване-решение за следното описание на продукта:\n\n" . $description . "\in\Име на продукта:\и" . $title . "\nn\Целева аудитория:\n" . $audience . "\n\n";
                return $prompt;
                break;
            default:
                # code...
