    ...
    public function createSummarize2ndGraderPrompt($description, $language)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "این متن را برای کلاس دوم خلاصه کنید:\n\n" . $description . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "สรุปข้อความนี้สำหรับนักเรียนชั้นประถมศึกษาปีที่ 2:\n\n" . $description . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Підсумуйте цей текст для 2-класника:\n\n" . $description . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Apibendrinkite šį tekstą 2 klasės mokiniui:\n\n" . $description . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Обобщете този текст за второкласник:\n\n" . $description . "\n\n";
                return $prompt;
                break;
            default:
                # code...
