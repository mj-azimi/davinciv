    ...
    public function createGrammarCheckerPrompt($description, $language)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "دستور زبان این متن را بررسی و تصحیح کنید:\n\n" . $description . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "ตรวจสอบและแก้ไขไวยากรณ์ของข้อความนี้:\n\n" . $description . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Перевірте та виправте граматику цього тексту:\n\n" . $description . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Patikrinkite ir pataisykite šio teksto gramatiką:\n\n" . $description . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Проверете и коригирайте граматиката на този текст:\n\n" . $description . "\n\n";
                return $prompt;
                break;
            default:
                # code...
