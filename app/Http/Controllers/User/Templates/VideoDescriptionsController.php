    ...
    public function createVideoDescriptionsPrompt($description, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "توضیحات قانع کننده YouTube را بنویسید تا مردم را به تماشای آن علاقه مند کنید.\n\nشرح ویدیو:\n" . $description . "\n\n لحن صدای توضیحات ویدیو باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนคำอธิบาย YouTube ที่น่าสนใจเพื่อให้ผู้คนสนใจรับชม\n\n คำอธิบายวิดีโอ:\n" . $description . "\nเสียงของคำอธิบายวิดีโอต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть переконливий опис YouTube, щоб зацікавити людей переглядом.\n\n Опис відео:\n" . $description . "\n\nТон опису відео має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite patrauklų „YouTube“ aprašą, kad žmonės susidomėtų žiūrėti.\n\n Vaizdo įrašo aprašymas:\n" . $description . "\n\Vaizdo įrašo aprašymo balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете завладяващо описание в YouTube, за да накарате хората да се заинтересуват да гледат.\n\n Описание на видеоклипа:\n" . $description . "\n\nТонът на гласа на видео описанието трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
