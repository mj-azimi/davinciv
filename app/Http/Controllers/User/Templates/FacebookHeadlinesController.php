    ...
    public function createFacebookHeadlinesPrompt($title, $audience, $description, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "یک تیتر خلاقانه طولانی برای محصول زیر بنویسید تا در Facebook اجرا شود با هدف:\n\n" . $audience . "\n\n نام محصول:\n" . $title . "\n\n توضیحات محصول:\n" . $description . "\n\n لحن صدای تیتر باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนพาดหัวโฆษณาแบบยาวเพื่อให้ผลิตภัณฑ์ต่อไปนี้ทำงานบน Facebook โดยมุ่งเป้าไปที่:\n\n" . $audience . "\n\n ชื่อผลิตภัณฑ์:\n" . $title . "\n\n รายละเอียดสินค้า:\n" . $description . "\n\n น้ำเสียงพาดหัวต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть довгий креативний заголовок для наступного продукту для показу на Facebook, спрямованого на:\n\n" . $audience . "\n\n Назва продукту:\n" . $title . "\n\n Опис продукту:\n" . $description . "\n\n Тон заголовка має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite ilgą kūrybinę antraštę, kad šis produktas būtų paleistas „Facebook“ ir skirtas:\n\n" . $audience . "\n\n Produkto pavadinimas:\n" . $title . "\n\n Produkto aprašymas:\n" . $description . "\n\n Antraštės balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете дълго творческо заглавие за следния продукт, който да се пусне във Facebook и е насочен към:\n\n" . $audience . "\n\n Име на продукта:\n" . $title . "\n\n Описание на продукта:\n" . $description . "\n\n Тонът на гласа на заглавието трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
