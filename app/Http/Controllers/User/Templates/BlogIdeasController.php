    ...
    public function createBlogIdeasPrompt($title, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "ایده های جالب وبلاگ و طرح کلی بنویسید در مورد:\n\n" . $title . "\n\n لحن صدای ایده ها باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนแนวคิดและโครงร่างบล็อกที่น่าสนใจเกี่ยวกับ:\n\n" . $title . "\n\n น้ำเสียงของความคิดต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть цікаві ідеї для блогу та окресліть:\n\n" . $title . "\n\n Тон голосу ідей має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite įdomių tinklaraščio idėjų ir apibūdinkite apie:\n\n" . $title . "\n\n Idėjų balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете интересни идеи за блог и очертайте:\n\n" . $title . "\n\n Тонът на гласа на идеите трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
