    ...
    public function createTalkingPointsPrompt($title, $keywords, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "نکات سخن کوتاه ، ساده و آموزنده بنویسید برای:\n\n" . $title . "\n\nو همچنین نقاط صحبت مشابه برای عناوین:\n" . $keywords . "\n\n لحن صدای پاراگراف باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
