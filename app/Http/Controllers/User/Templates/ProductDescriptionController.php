    ...
    public function createProductDescriptionPrompt($title, $audience, $description, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "توضیحات محصول خلاقانه طولانی بنویسید برای:" . $title . "\n\nمخاطب هدف است:" . $audience . "\n\nاز این توضیحات استفاده کنید:" . $description . "\n\nلحن متن تولید شده باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนคำอธิบายผลิตภัณฑ์ที่สร้างสรรค์แบบยาวสำหรับ:" . $title . "\n\nกลุ่มเป้าหมายคือ:" . $audience . "\n\nใช้คำอธิบายนี้:" . $description . "\n\nเสียงของข้อความที่สร้างขึ้นต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть довгий креативний опис продукту для:" . $title . "\n\nЦільова аудиторія:" . $audience . "\n\nВикористовуйте цей опис:" . $description . "\n\nТон створеного тексту має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite ilgą kūrybinį produkto aprašymą:" . $title . "\n\nTikslinė auditorija yra:" . $audience . "\n\nNaudokite šį aprašymą:" . $description . "\n\nSugeneruoto teksto tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете дълго творческо описание на продукта за:" . $title . "\n\nЦелевата аудитория е:" . $audience . "\n\nИзползвайте това описание:" . $description . "\n\nТонът на генерирания текст трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
