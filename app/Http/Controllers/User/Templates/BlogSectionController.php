    ...
    public function createBlogSectionPrompt($title, $subheadings, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "یک بخش کامل وبلاگ را با حداقل 5 پاراگراف بزرگ بنویسید در مورد:\n\n" . $title . "\n\nتقسیم شده توسط زیرنویس ها:\n" . $subheadings . "\n\لحن صدای پاراگراف ها باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนบล็อกแบบเต็มโดยมีย่อหน้าใหญ่อย่างน้อย 5 ย่อหน้าเกี่ยวกับ:\n\n" . $title . "\n\nแบ่งตามหัวข้อย่อย:\n" . $subheadings . "\n\nเสียงของย่อหน้าต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть повний розділ блогу, щонайменше 5 великих абзаців про:\n\n" . $title . "\n\nРозділити за підзаголовками:\n" . $subheadings . "\n\nТон абзаців має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite visą tinklaraščio skyrių su bent 5 didelėmis pastraipomis apie:\n\n" . $title . "\n\nPadalinta pagal paantraštes:\n" . $subheadings . "\n\nPastraipų balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете цял блог с поне 5 големи абзаца за:\n\n" . $title . "\n\nРазделени по подзаглавия:\n" . $subheadings . "\n\nТонът на гласа на параграфите трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
