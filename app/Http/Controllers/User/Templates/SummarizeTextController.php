    ...
    public function createSummarizeTextPrompt($text, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "این متن را به روشی کوتاه و مختصر خلاصه کنید:\n\n" . $text . "\n\nلحن خلاصه باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "สรุปข้อความนี้อย่างสั้นกระชับ:\n\n" . $text . "\n\nเสียงสรุปต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Коротко викладіть цей текст:\n\n" . $text . "\n\nТон резюме має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Trumpai glaustai apibendrinkite šį tekstą:\n\n" . $text . "\n\nSantraukos tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Резюмирайте този текст по кратък стегнат начин:\n\n" . $text . "\n\nТонът на обобщението трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
