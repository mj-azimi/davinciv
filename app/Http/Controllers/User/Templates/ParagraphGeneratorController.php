    ...
    public function createParagraphGeneratorPrompt($title, $keywords, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "یک پاراگراف بزرگ و معنی دار در مورد این موضوع بنویسید:\n\n" . $title . "\n\nدر پاراگراف از کلمات کلیدی زیر استفاده کنید:\n" . $keywords . "\n\nلحن صدای پاراگراف باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
