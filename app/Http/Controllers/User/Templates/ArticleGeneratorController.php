    ...
    public function createArticleGeneratorPrompt($title, $keywords, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "مقاله کاملی در مورد این موضوع بنویسید:\n\n" . $title . "\n\nاز کلمات کلیدی زیر در مقاله استفاده کنید:\n" . $keywords . "\n\لحن صدای مقاله باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนบทความฉบับสมบูรณ์เกี่ยวกับหัวข้อนี้:\n\n" . $title . "\n\nใช้คำหลักต่อไปนี้ในบทความ:\n" . $keywords . "\n\nน้ำเสียงของบทความต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть повну статтю на цю тему:\n\n" . $title . "\n\nВикористовуйте такі ключові слова в статті:\n" . $keywords . "\n\nТон статті має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite visą straipsnį šia tema:\n\n" . $title . "\n\nStraipsnyje naudokite šiuos raktinius žodžius:\n" . $keywords . "\n\nStraipsnio balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете пълна статия по тази тема:\n\n" . $title . "\n\nИзползвайте следните ключови думи в статията:\n" . $keywords . "\n\nТонът на статията трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
