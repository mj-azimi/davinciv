    ...
    public function createCreativeStoriesPrompt($description, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "یک داستان خلاقانه بنویسید در مورد:\n\n" . $description . "\n\لحن صدای داستان باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนเรื่องราวที่สร้างสรรค์เกี่ยวกับ:\n\n" . $description . "\n\nน้ำเสียงของเรื่องต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть творчу розповідь про:\n\n" . $description . "\n\nТон розповіді має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite kūrybinę istoriją apie:\n\n" . $description . "\n\nIstorijos balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете творческа история за:\n\n" . $description . "\n\nТонът на гласа на историята трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
