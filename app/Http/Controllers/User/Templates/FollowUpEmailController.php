    ...
    public function createFollowUpEmailPrompt($title, $description, $event, $keywords, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "یک ایمیل پیگیری بنویسید در مورد:\n\n" . $description . "\n\nشرکت یا نام محصول ما است:\n" . $title . "\n\nپیگیری بعد:\n" . $event . "\n\nمخاطب هدف است:\n" . $keywords . "\n\nلحن صدای ایمیل پیگیری باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
