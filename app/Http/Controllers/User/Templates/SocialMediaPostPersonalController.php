    ...
    public function createSocialPostPersonalPrompt($description, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "یک پست رسانه اجتماعی شخصی بنویسید در مورد:\n\n" . $description . "\n\nلحن صدای پست باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนโพสต์โซเชียลมีเดียส่วนตัวเกี่ยวกับ:\n\n" . $description . "\n\nน้ำเสียงของโพสต์ต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть особисту публікацію в соціальних мережах про:\n\n" . $description . "\n\nТон допису має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite asmeninį socialinių tinklų įrašą apie:\n\n" . $description . "\n\nĮrašo balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете лична публикация в социалните медии за:\n\n" . $description . "\n\nТонът на публикацията трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
