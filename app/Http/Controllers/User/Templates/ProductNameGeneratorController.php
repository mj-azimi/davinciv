    ...
    public function createProductNameGeneratorPrompt($keywords, $description, $language)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "نام محصولات خلاق را ایجاد کنید: " . $description . "\n\nکلمات منبع: " . $keywords . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "สร้างชื่อผลิตภัณฑ์อย่างสร้างสรรค์:" . $description . "\n\nคำที่ใช้: " . $keywords . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Створіть творчі назви продуктів: " . $description . "\n\nПочаткові слова: " . $keywords . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Sukurkite kūrybinius produktų pavadinimus: " . $description . "\n\nPradiniai žodžiai: " . $keywords . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Създайте творчески имена на продукти: " . $description . "\n\nСедлови думи: " . $keywords . "\n\n";
                return $prompt;
                break;
            default:
                # code...
