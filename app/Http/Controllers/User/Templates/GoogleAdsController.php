    ...
    public function createGoogleAdsPrompt($title, $audience, $description, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "توضیحات Google Ads را بنویسید که باعث می شود تبلیغ شما متمایز شود و منجر به تولید شود.مخاطب هدف:\n\n" . $audience . "\n\n نام محصول:\n" . $title . "\n\n توضیحات محصول:\n" . $description . "\n\n لحن صدای آگهی باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนคำอธิบาย Google Ads ที่ทำให้โฆษณาของคุณโดดเด่นและสร้างโอกาสในการขาย ผู้ชมเป้าหมาย:\n\n" . $audience . "\n\n ชื่อผลิตภัณฑ์:\n" . $title . "\n\n รายละเอียดสินค้า:\n" . $description . "\n\n น้ำเสียงของโฆษณาต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть опис Google Ads, який виділятиме вашу рекламу та залучатиме потенційних клієнтів. Цільова аудиторія:\n\n" . $audience . "\n\n Назва продукту:\n" . $title . "\n\n Опис продукту:\n" . $description . "\n\n Тон голосу оголошення має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite Google Ads aprašą, kad jūsų skelbimas išsiskirtų ir pritrauktų potencialių klientų. Tikslinė auditorija:\n\n" . $audience . "\n\n Produkto pavadinimas:\n" . $title . "\n\n Produkto aprašymas:\n" . $description . "\n\n Skelbimo balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете описание в Google Ads, което прави рекламата ви да се откроява и генерира потенциални клиенти. Целева аудитория:\n\n" . $audience . "\n\n Име на продукта:\n" . $title . "\n\n Описание на продукта:\n" . $description . "\n\n Тонът на гласа на рекламата трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
