    ...
    public function createFacebookAdsPrompt($title, $audience, $description, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "یک تبلیغ خلاقانه برای محصول زیر بنویسید تا در Facebook اجرا شود با هدف :\n\n" . $audience . "\n\n نام محصول:\n" . $title . "\n\n توضیحات محصول:\n" . $description . "\n\n لحن صدای آگهی باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนโฆษณาที่สร้างสรรค์สำหรับผลิตภัณฑ์ต่อไปนี้เพื่อทำงานบน Facebook โดยมุ่งเป้าไปที่:\n\n" . $audience . "\n\n ชื่อผลิตภัณฑ์:\n" . $title . "\n\n รายละเอียดสินค้า:\n" . $description . "\n\n น้ำเสียงของโฆษณาต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть креативне оголошення для наступного продукту для показу на Facebook, спрямоване на:\n\n" . $audience . "\n\n Назва продукту:\n" . $title . "\n\n Опис продукту:\n" . $description . "\n\n Тон голосу оголошення має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite šio produkto kūrybinį skelbimą, kad jis būtų rodomas „Facebook“, skirtas:\n\n" . $audience . "\n\n Produkto pavadinimas:\n" . $title . "\n\n Produkto aprašymas:\n" . $description . "\n\n Skelbimo balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете творческа реклама за следния продукт, която да се пусне във Facebook и е насочена към:\n\n" . $audience . "\n\n Име на продукта:\n" . $title . "\n\n Описание на продукта:\n" . $description . "\n\n Тонът на гласа на рекламата трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
