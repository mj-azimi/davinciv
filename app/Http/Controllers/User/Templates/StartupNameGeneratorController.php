    ...
    public function createStartupNameGeneratorPrompt($keywords, $description, $language)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "برای توضیحات استارتاپ نام های باحال ، خلاق و جذاب ایجاد کنید: " . $description . "\n\nکلمات منبع: " . $keywords . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "สร้างชื่อที่เจ๋ง สร้างสรรค์ และติดหูสำหรับคำอธิบายการเริ่มต้น: " . $description . "\n\nคำที่ใช้: " . $keywords . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Створюйте круті, креативні та привабливі назви для опису запуску: " . $description . "\n\nПочаткові слова: " . $keywords . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Generuokite šaunius, kūrybingus ir patrauklius paleidimo aprašymo pavadinimus:" . $description . "\n\nPradiniai žodžiai: " . $keywords . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Генерирайте страхотни, креативни и запомнящи се имена за описание при стартиране: " . $description . "\n\nСедлови думи: " . $keywords . "\n\n";
                return $prompt;
                break;
            default:
                # code...
