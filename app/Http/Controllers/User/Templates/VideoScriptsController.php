    ...
    public function createVideoScriptsPrompt($description, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "یک فیلمنامه ویدیویی جالب بنویسید در مورد:\n\n" . $description . "\n\nلحن صدای فیلمنامه ویدیویی باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนสคริปต์วิดีโอที่น่าสนใจเกี่ยวกับ:\n\n" . $description . "\n\nน้ำเสียงของสคริปต์วิดีโอต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть сценарій цікавого відео про:\n\n" . $description . "\n\nТон голосу сценарію відео має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite įdomų vaizdo įrašo scenarijų apie:\n\n" . $description . "\n\nVaizdo įrašo scenarijaus balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете интересен видео сценарий за:\n\n" . $description . "\n\nТонът на гласа на видео сценария трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
