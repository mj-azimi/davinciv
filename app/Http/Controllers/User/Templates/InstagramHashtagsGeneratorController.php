    ...
    public function createInstagramHashtagsPrompt($keyword, $language)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "بهترین هشتگ ها را برای استفاده برای این کلمه کلیدی Instagram پیدا کنید:\n\n" . $keyword . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "ค้นหาแฮชแท็กที่ดีที่สุดเพื่อใช้สำหรับคีย์เวิร์ด Instagram นี้:\n\n" . $keyword . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Знайдіть найкращі хештеги для цього ключового слова Instagram:\n\n" . $keyword . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Rasti geriausias žymas su grotelėmis, kurias galima naudoti šiam „Instagram“ raktiniam žodžiui:\n\n" . $keyword . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Намерете най-добрите хаштагове, които да използвате за тази ключова дума в Instagram:\n\n" . $keyword . "\n\n";
                return $prompt;
                break;
            default:
                # code...
