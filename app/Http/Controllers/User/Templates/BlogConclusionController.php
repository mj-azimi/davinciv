    ...
    public function createBlogConclusionPrompt($title, $description, $language, $tone)
    {
        ...
        switch ($language) {
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนสรุปบทความบล็อกสำหรับ:\n\n" . $description . "\n\n ชื่อบทความบล็อก:\n" . $title . "\n\nเสียงสรุปต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть висновок статті в блозі для:\n\n" . $description . "\n\n Назва статті блогу:\n" . $title . "\n\nТон висновку повинен бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite tinklaraščio straipsnio išvadą:\n\n" . $description . "\n\n Tinklaraščio straipsnio pavadinimas:\n" . $title . "\n\nIšvados balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете заключение за статия в блог за:\n\n" . $description . "\n\n Заглавие на блог статия:\n" . $title . "\n\nТонът на гласа на заключението трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'fa-IR':
                $prompt = "نتیجه گیری مقاله وبلاگ را بنویس برای:\n\n" . $description . "\n\n عنوان مقاله وبلاگ:\n" . $title . "\n\لحن صدای نتیجه گیری باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
