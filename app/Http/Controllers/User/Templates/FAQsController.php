    ...
    public function createFAQsPrompt($title, $description, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "لیست 10 سؤال ایجاد کنید که اغلب مطرح می شود بر اساس توضیحات:\n\n" . $description . "\n\n نام محصول:\n" . $title . "\n\n لحن صدای سوالات باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "สร้างรายการคำถามที่พบบ่อย 10 รายการตามคำอธิบาย:\n\n" . $description . "\n\n ชื่อผลิตภัณฑ์:\n" . $title . "\n\n เสียงของคำถามต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Створити список із 10 поширених запитань на основі опису:\n\n" . $description . "\n\n Назва продукту:\n" . $title . "\n\n Тон голосу запитань має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Sukurkite 10 dažniausiai užduodamų klausimų sąrašą pagal aprašymą:\n\n" . $description . "\n\n Produkto pavadinimas:\n" . $title . "\n\n Klausimų balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Генериране на списък от 10 често задавани въпроса въз основа на описание:\n\n" . $description . "\n\n Име на продукта:\n" . $title . "\n\n Тонът на гласа на въпросите трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
