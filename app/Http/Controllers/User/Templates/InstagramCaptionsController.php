    ...
    public function createInstagramCaptionsPrompt($description, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "با کپشن های جذاب برای این پست اینستاگرام توجه را جلب کنید:\n\n" . $description . "\n\nلحن صدای زیرنویس ها باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "ดึงดูดความสนใจด้วยคำบรรยายที่ติดหูสำหรับโพสต์ Instagram นี้:\n\n" . $description . "\n\nน้ำเสียงของคำบรรยายต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Привертайте увагу привабливими підписами до цієї публікації в Instagram:\n\n" . $description . "\n\nТон субтитрів має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Patraukite dėmesį patraukliais šio Instagram įrašo antraštėmis:\n\n" . $description . "\n\nSubtitrų balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Привлечете вниманието със закачливи надписи за тази публикация в Instagram:\n\n" . $description . "\n\nТонът на надписите трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
