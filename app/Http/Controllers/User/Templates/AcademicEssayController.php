    ...
    public function createAcademicEssayPrompt($title, $keywords, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "بنویس یک مقاله علمی در مورد:\n\n" . $title . "\n\nدر مقاله از کلمات کلیدی زیر استفاده کنید:\n" . $keywords . "\n\لحن صدای مقاله باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
