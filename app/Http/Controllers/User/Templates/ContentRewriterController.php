    ...
    public function createContentRewriterPrompt($title, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "متن زیر را به روشی خلاقانه و هوشمند بهبود و بازنویسی کنید:\n\n" . $title . "\n\n لحن صدای نتیجه باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "ปรับปรุงและเขียนข้อความใหม่ด้วยวิธีที่สร้างสรรค์และชาญฉลาด:\n\n" . $title . "\n\n เสียงของผลลัพธ์ต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Удосконалюйте та переписуйте текст креативно та розумно:\n\n" . $title . "\n\n Тон голосу результату повинен бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Patobulinkite ir perrašykite tekstą kūrybiškai ir sumaniai:\n\n" . $title . "\n\n Rezultato balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Подобрете и пренапишете текста по креативен и интелигентен начин:\n\n" . $title . "\n\n Тонът на гласа на резултата трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
