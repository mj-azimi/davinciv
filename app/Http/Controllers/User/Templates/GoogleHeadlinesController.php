    ...
    public function createGoogleHeadlinesPrompt($title, $audience, $description, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "برای تبلیغ محصول خود با Google Ads ، عناوین 30 کاراکتری جذاب را بنویسید.نام محصول:\n\n" . $title . "\n\nتوضیحات محصول:\n" . $description . "\n\nمخاطبان هدف برای تبلیغات:\n" . $audience . "\n\nلحن صدای تیتر باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนบรรทัดแรก 30 อักขระที่ดึงดูดใจเพื่อโปรโมตผลิตภัณฑ์ของคุณด้วย Google Ads ชื่อผลิตภัณฑ์:\n\n" . $title . "\n\nรายละเอียดสินค้า:\n" . $description . "\n\nกลุ่มเป้าหมายสำหรับโฆษณา:\n" . $audience . "\n\nน้ำเสียงของพาดหัวต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть привабливі заголовки з 30 символів, щоб рекламувати свій продукт за допомогою Google Ads. Назва продукту:\n\n" . $title . "\n\nОпис товару:\n" . $description . "\n\nЦільова аудиторія для реклами:\n" . $audience . "\n\nТон заголовка має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite patrauklias 30 simbolių antraštes, kad reklamuotumėte savo produktą naudodami Google Ads. Produkto pavadinimas:\n\n" . $title . "\n\nProdukto aprašymas:\n" . $description . "\n\nSkelbimo tikslinė auditorija:\n" . $audience . "\n\nAntraštės balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете закачливи заглавия от 30 знака, за да популяризирате продукта си с Google Ads. Име на продукта:\n\n" . $title . "\n\nОписание на продукта:\n" . $description . "\n\nЦелева аудитория за реклама:\n" . $audience . "\n\nТонът на заглавието трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
