    ...
    public function createSocialPostBusinessPrompt($description, $title, $post, $language)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "یک پست بزرگ رسانه های اجتماعی حرفه ای برای شرکت من ایجاد کنید.شرح پست:\n\n" . $post . "\n\nتوضیحات شرکت:\n" . $description . "\n\nنام شرکت:\n" . $title . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "สร้างโพสต์โซเชียลมีเดียระดับมืออาชีพขนาดใหญ่สำหรับบริษัทของฉัน คำอธิบายโพสต์:\n\n" . $post . "\n\nคำอธิบายบริษัท:\n" . $description . "\n\nชื่อบริษัท:\n" . $title . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Створіть великий професійний допис у соціальних мережах для моєї компанії. Опис допису:\n\n" . $post . "\n\nОпис компанії:\n" . $description . "\n\nНазва компанії:\n" . $title . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Sukurkite didelį profesionalų mano įmonės socialinės žiniasklaidos įrašą. Įrašo aprašas:\n\n" . $post . "\n\nĮmonės aprašymas:\n" . $description . "\n\nĮmonės pavadinimas:\n" . $title . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Създайте голяма професионална публикация в социалните медии за моята компания. Описание на публикацията:\n\n" . $post . "\n\nОписание на фирмата:\n" . $description . "\n\nИме на фирмата:\n" . $title . "\n\n";
                return $prompt;
                break;
            default:
                # code...
