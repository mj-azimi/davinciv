    ...
    public function createColdEmailPrompt($title, $description, $keywords, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "یک ایمیل رسمی بنویسید در مورد :\n\n" . $description . "\n\nشرکت یا نام محصول ما است:\n" . $title . "\n\nزمینه ای که در ایمیل رسمی قرار دارد:\n" . $keywords . "\n\لحن صدای ایمیل رسمی باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
