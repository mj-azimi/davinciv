    ...
    public function createMetaDescriptionPrompt($title, $keywords, $description, $language)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "توضیحات متا SEO را بنویسید برای:\n\n" . $description . "\n\nنام وب سایت است:\n" . $title . "\n\nکلمات منبع:\n" . $keywords . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนคำอธิบายเมตา SEO สำหรับ:\n\n" . $description . "\in\ชื่อเว็บไซต์คือ:\n" . $title . "\in\คำที่ใช้ตั้ง:\n" . $keywords . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть метаопис SEO для:\n\n" . $description . "\in\Назва веб-сайту:\n" . $title . "\у\Початкові слова:\n" . $keywords . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite SEO metaaprašą:\n\n" . $description . "\in\Svetainės pavadinimas yra:\n" . $title . "\in\ Pradiniai žodžiai:\n" . $keywords . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете SEO мета описание за:\n\n" . $description . "\in\Името на уебсайта е:\n" . $title . "\in\Seed words:\n" . $keywords . "\n\n";
                return $prompt;
                break;
            default:
                # code...
