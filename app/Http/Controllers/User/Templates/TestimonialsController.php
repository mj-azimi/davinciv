    ...
    public function createTestimonialsPrompt($title, $description, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "5 نظر خلاقانه مشتری برای یک محصول ایجاد کنید. نام محصول:\n\n" . $title . "\n\n توضیحات محصول:\n" . $description . "\n\n لحن صدای بررسی مشتری باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "สร้างบทวิจารณ์จากลูกค้าเชิงสร้างสรรค์ 5 รายการสำหรับผลิตภัณฑ์หนึ่งๆ ชื่อผลิตภัณฑ์:\n\n" . $title . "\n\n รายละเอียดสินค้า:\n" . $description . "\n\n ความคิดเห็นของลูกค้าต้องเป็นเสียง:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Створіть 5 креативних відгуків клієнтів про продукт. Назва продукту:\n\n" . $title . "\n\n Опис продукту:\n" . $description . "\n\n Тон голосу відгуку клієнта повинен бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Sukurkite 5 kūrybingus klientų atsiliepimus apie produktą. Produkto pavadinimas:\n\n" . $title . "\n\n Produkto aprašymas:\n" . $description . "\n\n Kliento atsiliepimo balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Създайте 5 креативни клиентски рецензии за продукт. Име на продукта:\n\n" . $title . "\n\n Описание на продукта:\n" . $description . "\n\n Тонът на рецензията на клиента трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
