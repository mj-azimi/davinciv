    ...
    public function createFAQAnswersPrompt($title, $question, $description, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "ایجاد کنید 5 پاسخ خلاقانه برای سوال:\n\n" . $question . "\n\n نام محصول:\n" . $title . "\n\n توضیحات محصول:\n" . $description . "\n\n لحن صدای پاسخ ها باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "สร้างครีเอทีฟ 5 คำตอบสำหรับคำถาม:\n\n" . $question . "\n\n ชื่อผลิตภัณฑ์:\n" . $title . "\n\n รายละเอียดสินค้า:\n" . $description . "\n\n น้ำเสียงของคำตอบต้องเป็น:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Створіть творчі 5 відповідей на запитання:\n\n" . $question . "\n\n Назва продукту:\n" . $title . "\n\n Опис продукту:\n" . $description . "\n\n Тон голосу відповідей має бути:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Sukurkite 5 kūrybingus atsakymus į klausimą:\n\n" . $question . "\n\n Produkto pavadinimas:\n" . $title . "\n\n Produkto aprašymas:\n" . $description . "\n\n Atsakymų balso tonas turi būti:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Генерирайте творчески 5 отговора на въпрос:\n\n" . $question . "\n\n Име на продукта:\n" . $title . "\n\n Описание на продукта:\n" . $description . "\n\n Тонът на гласа на отговорите трябва да бъде:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            default:
                # code...
