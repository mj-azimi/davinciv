    ...
    public function createVideoTitlesPrompt($description, $language)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "عنوان ویدیوی YouTube جذاب را برای توضیحات ارائه شده بنویسید تا مردم به تماشای آن علاقه مند شوند:\n\nشرح ویدیو:\n" . $description . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนชื่อวิดีโอ YouTube ที่น่าสนใจสำหรับคำอธิบายวิดีโอที่ให้มาเพื่อให้ผู้คนสนใจรับชม:\n\nคำอธิบายวิดีโอ:\n" . $description . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть переконливу назву відео YouTube для наданого опису відео, щоб зацікавити людей до перегляду:\n\nОпис відео:\n" . $description . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite patrauklų „YouTube“ vaizdo įrašo pavadinimą pateiktam vaizdo įrašo aprašui, kad žmonės susidomėtų žiūrėti:\n\nVaizdo įrašo aprašas:\n" . $description . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете завладяващо заглавие на видеоклипа в YouTube за предоставеното описание на видеоклипа, за да предизвикате интерес у хората да гледат:\n\nОписание на видеоклипа:\n" . $description . "\n\n";
                return $prompt;
                break;
            default:
                # code...
