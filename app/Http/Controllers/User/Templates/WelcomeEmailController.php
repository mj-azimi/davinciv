    ...
    public function createWelcomeEmailPrompt($title, $description, $keywords, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "یک ایمیل خوش آمدگویی بنویسید درباره:\n\n" . $description . "\n\nشرکت یا نام محصول ما است:\n" . $title . "\n\nمخاطب هدف است:\n" . $keywords . "\n\nلحن صدای ایمیل خوش آمدگویی باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
