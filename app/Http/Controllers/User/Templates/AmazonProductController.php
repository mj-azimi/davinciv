    ...
    public function createAmazonProductPrompt($title, $keywords, $language)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "توضیحات مربوط به بازار آمازون را برای توضیحات محصول زیر بنویسید:\n\n" . $title . "\n\nدر توضیحات محصول از کلمات کلیدی زیر استفاده کنید:\n" . $keywords . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "เขียนคำอธิบายผลิตภัณฑ์ในตลาดกลางของ Amazon ที่ดึงดูดใจสำหรับ:\n\n" . $title . "\n\nใช้คำหลักต่อไปนี้ในรายละเอียดสินค้า:\n" . $keywords . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Напишіть опис продукту Amazon Marketplace для:\n\n" . $title . "\n\nВикористовуйте такі ключові слова в описі продукту:\n" . $keywords . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Parašykite dėmesį patraukiančio Amazon prekyvietės produkto aprašymą:\n\n" . $title . "\n\nProdukto aprašyme naudokite šiuos raktinius žodžius:\n" . $keywords . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Напишете грабващо вниманието описание на продукта на пазара на Amazon за:\n\n" . $title . "\n\nИзползвайте следните ключови думи в описанието на продукта:\n" . $keywords . "\n\n";
                return $prompt;
                break;
            default:
                # code...
