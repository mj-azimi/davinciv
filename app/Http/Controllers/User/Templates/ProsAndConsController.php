    ...
    public function createProsAndConsPrompt($title, $keywords, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "جوانب مثبت و منفی این محصولات را بنویسید:\n\n" . $title . "\n\nاز توضیحات محصول زیر استفاده کنید:\n" . $keywords . "\n\nلحن صدای جوانب مثبت و منفی باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
