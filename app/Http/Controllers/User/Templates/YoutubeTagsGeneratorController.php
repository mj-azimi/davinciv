    ...
    public function createYoutubeTagsGeneratorPrompt($title, $language)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "برچسب‌ها و کلمات کلیدی YouTube بهینه شده برای SEO را ایجاد کنید برای:\n\n" . $title . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "สร้างแท็ก YouTube ที่ปรับให้เหมาะสม SEO และคำหลักสำหรับ:\n\n" . $title . "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Створіть оптимізовані для SEO теги та ключові слова YouTube для:\n\n" . $title . "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Generuokite pagal SEO optimizuotas „YouTube“ žymas ir raktinius žodžius:\n\n" . $title . "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Генериране на оптимизирани за SEO маркери и ключови думи в YouTube за:\n\n" . $title . "\n\n";
                return $prompt;
                break;
            default:
                # code...
