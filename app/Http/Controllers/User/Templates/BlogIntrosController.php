    ...
    public function createBlogIntrosPrompt($title, $description, $language, $tone)
    {
        ...
        switch ($language) {
            case 'en-US':
                ...
                break;
            case 'fa-IR':
                $prompt = "یک پست جالب وبلاگ بنویسید درباره:\n\n" . $description . "\n\n عنوان پست وبلاگ:\n" . $title . "\n\nلحن صدای معرفی وبلاگ باید باشد:\n" . $tone_language . "\n\n";
                return $prompt;
                break;
            case 'ar-AE':
