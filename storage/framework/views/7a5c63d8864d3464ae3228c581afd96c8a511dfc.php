					...
					<form id="upgrade-form" method="POST" action="<?php echo e(route('admin.settings.upgrade.start', ['update_id' => $latest_version['update_id'], 'version' => $latest_version['version']])); ?>" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-sm-12 col-md-12">
								...
								<?php else: ?>
									<h6 class="text-success fs-14 font-weight-bold mt-4"><?php echo e(__('You have the latest version installed')); ?>!</h6>
								<?php endif; ?>
							</div>
						</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/ontnehbb/public_html/resources/views/admin/settings/upgrade/index.blade.php ENDPATH**/ ?>