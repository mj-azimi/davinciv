							...
							<div class="col-sm-12 col-md-12">
								<div class="input-box">
									<div class="form-group">
										<label class="form-label fs-12"><?php echo e(__('Enter Buyer order Id')); ?></label>
							...
							<div class="col-sm-12 col-md-12">
								<div class="input-box mb-1">
									<div class="form-group mb-1">
										<label class="form-label fs-12"><?php echo e(__('Enter Rtl Username')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/ontnehbb/public_html/resources/views/admin/settings/activation/index.blade.php ENDPATH**/ ?>