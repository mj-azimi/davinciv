				...
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							...
							<h2 class="mb-0"><span class="number-font fs-20"><?php echo e(number_format($total_data_monthly['transactions_current_month'][0]['data'])); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"> <?php echo e(__('this month')); ?></span></h2>
							...
							<table class="table" id="database-backup">
								...
								<tbody>
									<?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										...
										<td><?php if(App::currentLocale() === 'fa'): ?>
                                            <span class="font-weight-bold"><?php echo e(Carbon::datetopersian('d M Y', $data->created_at)); ?></span><br><span><?php echo e(date_format($data->created_at, 'H:i A')); ?></span>
                                            <?php else: ?>
                                            <span class="font-weight-bold"><?php echo e(date_format($data->created_at, 'd M Y')); ?></span><br><span><?php echo e(date_format($data->created_at, 'H:i A')); ?></span>
                                            <?php endif; ?></td>
										</tr>
...
<?php $__env->startSection('js'); ?>
	...
	<script type="text/javascript">
		$(function() {
			...
			let delayed3;
            var local = JSON.parse(`<?php echo $chart_data['local']; ?>`);
            let lbs = [];
            if ( local === 'fa')
                lbs = ['ژانویه', 'فوریه', 'مارس', 'آپریل', 'می', 'ژوئن', 'جولای', 'آگوست', 'سپتامبر', 'اکتبر', 'نوامبر', 'دسامبر'];
            else
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/davinciv/public_html/resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>