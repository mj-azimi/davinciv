	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#reviewsTable').DataTable({
				...
				"order": [[ 1, "desc" ]],
				language: {
					"emptyTable": "<div><?php echo e(__('No reviews created yet')); ?></div>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/davinciv/public_html/resources/views/admin/frontend/review/index.blade.php ENDPATH**/ ?>