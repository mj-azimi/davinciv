					...
					<div class="row" id="profile-pages">
						<div class="col-sm-12">
							<div class="text-center pt-4">
								<a href="<?php echo e(route('user.profile.edit')); ?>" class="fs-13 text-white"><i class="fa fa-calendar-lines-pen mr-1"></i> <?php echo e(__('Update Profile')); ?></a>
							</div>
						</div>
						<div class="col-sm-12">
					...
					<div class="card mb-5 border-0">
						<div class="card-header d-inline border-0">
							...
							<?php else: ?>
								...
								<div class="mb-1">
									<span class="fs-12 text-muted"><?php echo e($user_subscription->plan_name); ?> <?php echo e(__('Plan')); ?> / <?php echo config('payment.default_system_currency_symbol'); ?><?php echo e($user_subscription->price); ?> <?php if($user_subscription->payment_frequency == 'monthly'): ?> <?php echo e(__('Per Month')); ?> <?php else: ?> <?php echo e(__('Per Year')); ?> <?php endif; ?></span>
								</div>
							<?php endif; ?>
						</div>
						<div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/davinciv/public_html/resources/views/user/profile/index.blade.php ENDPATH**/ ?>