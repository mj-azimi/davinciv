									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											...
											<select id="time-zone" name="time-zone" data-placeholder="Select Time Zone">
												...
												<option value="Asia/Tehran" <?php if(config('app.timezone') == 'Asia/Tehran'): ?> selected <?php endif; ?>>(UTC+03:30) تهران</option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/davinciv/public_html/resources/views/admin/settings/global/index.blade.php ENDPATH**/ ?>