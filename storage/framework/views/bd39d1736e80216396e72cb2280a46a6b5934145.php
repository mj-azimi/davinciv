				...
				<div class="card border-0">
					...
					<div class="card-body pb-6">
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								<h6 class="fs-12 font-weight-bold mb-4"><img src="../../../../../public/img/payments/zarinpal.png" alt="ZarinPal" width="50" height="13" class="mx-2" ><?php echo e(__('ZarinPal Payment Gateway')); ?><span class="text-primary">(<?php echo e(__('All Plans')); ?>)</span></h6>
								
								<div class="row">
									<div class="col-md-6 col-sm-12 mb-2">
										<div class="form-group">
											<label class="custom-switch">
												<input type="checkbox" name="enable-zarinpal" class="custom-switch-input" <?php if(config('services.zarinpal.enable')  == 'on'): ?> checked <?php endif; ?>>
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description"><?php echo e(__('Use ZarinPal Prepaid')); ?></span>
											</label>
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												<input type="checkbox" name="enable-zarinpal-subscription" class="custom-switch-input" <?php if(config('services.zarinpal.subscription')  == 'on'): ?> checked <?php endif; ?>>
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description"><?php echo e(__('Use ZarinPal Subscription')); ?></span>
											</label>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">								
										<div class="input-box">								
											<h6><?php echo e(__('Merchant Id')); ?><span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
											<div class="form-group">							    
												<input type="text" class="form-control <?php $__errorArgs = ['zarinpal_merchant_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="zarinpal_merchant_id" name="zarinpal_merchant_id" value="<?php echo e(config('services.zarinpal.merchantID')); ?>" autocomplete="off">
											</div> 
											<?php $__errorArgs = ['zarinpal_merchant_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
												<p class="text-danger"><?php echo e($errors->first('zarinpal_merchant_id')); ?></p>
											<?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-md-6 col-sm-12 mb-2">
										<div class="form-group">
											<label class="custom-switch">
												<input type="checkbox" name="enable-sandbox-zarinpal" class="custom-switch-input" <?php if(config('services.zarinpal.sandbox')  == 'on'): ?> checked <?php endif; ?>>
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description"><?php echo e(__('Active Sandbox')); ?></span>
											</label>
										</div>
									</div>
								</div>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								<h6 class="fs-12 font-weight-bold mb-4"><i class="fa-brands fa-cc-paypal fs-16 mr-2"></i><?php echo e(__('PayPal Payment Gateway')); ?> <span class="text-primary">(<?php echo e(__('All Plans')); ?>)</span></h6>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><i class="fa-brands fa-cc-stripe fs-16 mr-2"></i><?php echo e(__('Stripe Payment Gateway')); ?> <span class="text-primary">(<?php echo e(__('All Plans')); ?>)</span></h6>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">								
										<!-- ACCESS KEY -->
										<div class="input-box">								
											<h6><?php echo e(__('Stripe Key')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<!-- SECRET ACCESS KEY -->
										<div class="input-box">								
											<h6><?php echo e(__('Stripe Secret Key')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6> 
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											<h6><?php echo e(__('Stripe Webhook URI')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6> 
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											<h6><?php echo e(__('Stripe Webhook Secret')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6> 
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											<h6><?php echo e(__('Stripe Base URI')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6> 
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="<?php echo e(URL::asset('/img/payments/paystack.svg')); ?>" alt="Paystack" class="gateway-logo"><?php echo e(__('Paystack Payment Gateway')); ?> <span class="text-primary">(<?php echo e(__('All Plans')); ?>)</span></h6>
									...
									<div class="col-md-6 col-sm-12 mb-2">
										<div class="form-group">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description"><?php echo e(__('Use Paystack Prepaid')); ?></span>
											</label>
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description"><?php echo e(__('Use Paystack Subscription')); ?></span>
											</label>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">								
										<!-- ACCESS KEY -->
										<div class="input-box">								
											<h6><?php echo e(__('Paystack Public Key')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<!-- SECRET ACCESS KEY -->
										<div class="input-box">								
											<h6><?php echo e(__('Paystack Secret Key')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6> 
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											<h6><?php echo e(__('Paystack Webhook URI')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6> 
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											<h6><?php echo e(__('Paystack Base URI')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6> 
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="<?php echo e(URL::asset('/img/payments/razorpay.svg')); ?>" alt="Razorpay" class="gateway-logo"><?php echo e(__('Razorpay Payment Gateway')); ?> <span class="text-primary">(<?php echo e(__('All Plans')); ?>)</span></h6>
									...
									<div class="col-md-6 col-sm-12 mb-2">
										<div class="form-group">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description"><?php echo e(__('Use Razorpay Prepaid')); ?></span>
											</label>
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description"><?php echo e(__('Use Razorpay Subscription')); ?></span>
											</label>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">								
										<!-- ACCESS KEY -->
										<div class="input-box">								
											<h6><?php echo e(__('Razorpay Key ID')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<!-- SECRET ACCESS KEY -->
										<div class="input-box">								
											<h6><?php echo e(__('Razorpay Key Secret')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6> 
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											<h6><?php echo e(__('Razorpay Webhook URI')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6> 
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											<h6><?php echo e(__('Razorpay Webhook Secret')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6> 
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											<h6><?php echo e(__('Razorpay Base URI')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6> 
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="<?php echo e(URL::asset('/img/payments/mollie.svg')); ?>" alt="Mollie" class="gateway-logo gateway-small-logo"><?php echo e(__('Mollie Payment Gateway')); ?> <span class="text-primary">(<?php echo e(__('All Plans')); ?>)</span></h6>
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description"><?php echo e(__('Use Mollie Prepaid')); ?></span>
											</label>
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description"><?php echo e(__('Use Mollie Subscription')); ?></span>
											</label>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">								
										<!-- ACCESS KEY -->
										<div class="input-box">								
											<h6><?php echo e(__('Mollie Public Key')); ?></h6>
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">								
										<div class="input-box">								
											<h6><?php echo e(__('Mollie Webhook URI')); ?></h6>
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">								
										<div class="input-box">								
											<h6><?php echo e(__('Mollie Base URI')); ?></h6>
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="<?php echo e(URL::asset('/img/payments/braintree.svg')); ?>" alt="Braintree" class="gateway-logo"><?php echo e(__('Braintree Payment Gateway')); ?> <span class="text-primary">(<?php echo e(__('Prepaid Plans')); ?>)</span></h6>
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description"><?php echo e(__('Use Braintree Prepaid')); ?></span>
											</label>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">								
										<!-- ACCESS KEY -->
										<div class="input-box">								
											<h6><?php echo e(__('Braintree Private Key')); ?></h6>
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">								
										<!-- ACCESS KEY -->
										<div class="input-box">								
											<h6><?php echo e(__('Braintree Public Key')); ?></h6>
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">		
										<div class="input-box">								
											<h6><?php echo e(__('Braintree Merchant ID')); ?></h6>
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											<h6><?php echo e(__('Braintree Environment')); ?></h6> 
...
unset($__errorArgs, $__bag); ?>
				...
				<div class="card border-0">
					<div class="card-header">
						<h3 class="card-title"><span class="text-info"> <?php echo e(__('Cryptocurrency')); ?> </span> <?php echo e(__('Payment')); ?></h3>
					</div>
					<div class="card-body pb-6">
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description"><?php echo e(__('Use Coinbase Prepaid')); ?></span>
											</label>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">		
										<div class="input-box">								
											<h6><?php echo e(__('Coinbase API Key')); ?></h6>
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">		
										<div class="input-box">								
											<h6><?php echo e(__('Coinbase Webhook Secret')); ?></h6>
											<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">		
										<div class="input-box">								
											<h6><?php echo e(__('Coinbase Webhook URI')); ?></h6>
											<div class="form-group">							    
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group mb-4">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description"><?php echo e(__('Use Bank Transfer Subscription')); ?></span>
											</label>
										</div>
									</div>
								</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/davinciv/public_html/resources/views/admin/finance/settings/index.blade.php ENDPATH**/ ?>