...
<?php $__env->startSection('page-header'); ?>
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0"><?php echo e(__('View Code')); ?></h4>
			...
			<li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('user.documents')); ?>"> <?php echo e(__('Documents')); ?></a></li>
				<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(url('#')); ?>"> <?php echo e(__('View Code')); ?></a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
...
unset($__errorArgs, $__bag); ?>
					...
					<div>						
						<div id="code-textarea">
							<pre>
								<code id="codetext"><?php echo $id->code; ?></code>
							</pre>						
						</div>									
					</div>

					<div class="border-0 text-right mb-4 mr-4">
						<a href="<?php echo e(route('user.documents.codes')); ?>" class="btn btn-primary"><?php echo e(__('Return')); ?></a>
					</div>
				</div>
			</div>
		</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/davinciv/public_html/resources/views/user/documents/codex/show.blade.php ENDPATH**/ ?>