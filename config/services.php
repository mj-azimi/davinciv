...
return [
    ...
    */
    ...
    'zarinpal' => [
        'enable' => env('ZARINPAL_ENABLED'),
        'subscription' => env('ZARINPAL_SUBSCRIPTION_ENABLED'),
        'merchantID' => env('ZARINPAL_MERCHANT_ID'),
        'zarinGate' => env('ZARINPAL_ENABLED_ZARIN_GATE'),
        'sandbox' => env('ZARINPAL_ENABLED_SANDBOX'),
        'class' => App\Services\ZarinPalService::class,
    ],
