...
Route::group(['prefix' => 'admin', 'middleware' => ['verified', '2fa.verify', 'role:admin', 'PreventBackHistory']], function() {
    ...
    Route::controller(ClearCacheController::class)->group(function() {
        ...
        Route::post('/settings/clear/symlink', 'createStorageLink')->name('admin.settings.clear.symlink');
    });
...
Route::group(['prefix' => 'user', 'middleware' => ['verified', '2fa.verify', 'role:user|admin|subscriber', 'PreventBackHistory']], function() {
    ...
    Route::controller(PaymentController::class)->group(function() {
        ...
        Route::get('/payments/approved/zarinpal', 'approvedZarinpalPrepaid')->name('user.payments.approved.zarinpal');
        ...
        Route::get('/payments/subscription/zarinpal', 'approvedZarinpalSubscription')->name('user.payments.subscription.zarinpal');
